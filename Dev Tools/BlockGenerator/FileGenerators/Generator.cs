...
namespace BlockGenerator.FileGenerators
{
    ...
    {
        private const string _copyrightText = @"// <copyright>
...
";
        ...
        protected string GenerateCSharpFile( IList<string> usings, string namespaceName, string body )
        {
            var sb = new StringBuilder( GetCopyrightText() );
        ...
        protected string GenerateTypeScriptFile( IList<TypeScriptImport> imports, string body )
        {
            var sb = new StringBuilder( GetCopyrightText() );
