...
namespace Rock.Model
{
    ...
    public partial class SignatureDocumentViewModelHelper : ViewModelHelper<SignatureDocument, Rock.ViewModel.Entities.SignatureDocumentBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.SignatureDocumentBag CreateViewModel( SignatureDocument model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.SignatureDocumentBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class SignatureDocumentExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.SignatureDocumentBag ToViewModel( this SignatureDocument model, Person currentPerson = null, bool loadAttributes = false )
        {
