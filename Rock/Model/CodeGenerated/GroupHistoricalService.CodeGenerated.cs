...
namespace Rock.Model
{
    ...
    public partial class GroupHistoricalViewModelHelper : ViewModelHelper<GroupHistorical, Rock.ViewModel.Entities.GroupHistoricalBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.GroupHistoricalBag CreateViewModel( GroupHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.GroupHistoricalBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class GroupHistoricalExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.GroupHistoricalBag ToViewModel( this GroupHistorical model, Person currentPerson = null, bool loadAttributes = false )
        {
