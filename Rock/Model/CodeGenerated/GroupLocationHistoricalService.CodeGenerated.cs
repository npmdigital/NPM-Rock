...
namespace Rock.Model
{
    ...
    public partial class GroupLocationHistoricalViewModelHelper : ViewModelHelper<GroupLocationHistorical, Rock.ViewModel.Entities.GroupLocationHistoricalBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.GroupLocationHistoricalBag CreateViewModel( GroupLocationHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.GroupLocationHistoricalBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class GroupLocationHistoricalExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.GroupLocationHistoricalBag ToViewModel( this GroupLocationHistorical model, Person currentPerson = null, bool loadAttributes = false )
        {
