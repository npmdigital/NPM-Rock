...
namespace Rock.Model
{
    ...
    public partial class AuthScopeViewModelHelper : ViewModelHelper<AuthScope, Rock.ViewModel.Entities.AuthScopeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.AuthScopeBag CreateViewModel( AuthScope model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.AuthScopeBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class AuthScopeExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.AuthScopeBag ToViewModel( this AuthScope model, Person currentPerson = null, bool loadAttributes = false )
        {
