...
namespace Rock.Model
{
    ...
    public partial class InteractionSessionViewModelHelper : ViewModelHelper<InteractionSession, Rock.ViewModel.Entities.InteractionSessionBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.InteractionSessionBag CreateViewModel( InteractionSession model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.InteractionSessionBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class InteractionSessionExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.InteractionSessionBag ToViewModel( this InteractionSession model, Person currentPerson = null, bool loadAttributes = false )
        {
