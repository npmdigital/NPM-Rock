...
namespace Rock.Model
{
    ...
    public partial class CampusViewModelHelper : ViewModelHelper<Campus, Rock.ViewModel.Entities.CampusBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.CampusBag CreateViewModel( Campus model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.CampusBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class CampusExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.CampusBag ToViewModel( this Campus model, Person currentPerson = null, bool loadAttributes = false )
        {
