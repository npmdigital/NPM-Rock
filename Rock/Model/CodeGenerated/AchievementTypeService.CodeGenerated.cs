...
namespace Rock.Model
{
    ...
    public partial class AchievementTypeViewModelHelper : ViewModelHelper<AchievementType, Rock.ViewModel.Entities.AchievementTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.AchievementTypeBag CreateViewModel( AchievementType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.AchievementTypeBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class AchievementTypeExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.AchievementTypeBag ToViewModel( this AchievementType model, Person currentPerson = null, bool loadAttributes = false )
        {
