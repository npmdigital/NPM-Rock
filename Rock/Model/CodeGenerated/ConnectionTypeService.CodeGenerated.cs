...
namespace Rock.Model
{
    ...
    public partial class ConnectionTypeViewModelHelper : ViewModelHelper<ConnectionType, Rock.ViewModel.Entities.ConnectionTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ConnectionTypeBag CreateViewModel( ConnectionType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ConnectionTypeBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ConnectionTypeExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ConnectionTypeBag ToViewModel( this ConnectionType model, Person currentPerson = null, bool loadAttributes = false )
        {
