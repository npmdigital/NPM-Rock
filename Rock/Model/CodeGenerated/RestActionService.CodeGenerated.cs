...
namespace Rock.Model
{
    ...
    public partial class RestActionViewModelHelper : ViewModelHelper<RestAction, Rock.ViewModel.Entities.RestActionBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.RestActionBag CreateViewModel( RestAction model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.RestActionBag
            {
                Id = model.Id,
                Guid = model.Guid,
                ApiId = model.ApiId,
    ...
    public static partial class RestActionExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.RestActionBag ToViewModel( this RestAction model, Person currentPerson = null, bool loadAttributes = false )
        {
