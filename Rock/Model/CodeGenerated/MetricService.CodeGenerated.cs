...
namespace Rock.Model
{
    ...
    public partial class MetricViewModelHelper : ViewModelHelper<Metric, Rock.ViewModel.Entities.MetricBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.MetricBag CreateViewModel( Metric model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.MetricBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class MetricExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.MetricBag ToViewModel( this Metric model, Person currentPerson = null, bool loadAttributes = false )
        {
