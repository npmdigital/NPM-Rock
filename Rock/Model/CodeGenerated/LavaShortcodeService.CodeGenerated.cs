...
namespace Rock.Model
{
    ...
    public partial class LavaShortcodeViewModelHelper : ViewModelHelper<LavaShortcode, Rock.ViewModel.Entities.LavaShortcodeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.LavaShortcodeBag CreateViewModel( LavaShortcode model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.LavaShortcodeBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class LavaShortcodeExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.LavaShortcodeBag ToViewModel( this LavaShortcode model, Person currentPerson = null, bool loadAttributes = false )
        {
