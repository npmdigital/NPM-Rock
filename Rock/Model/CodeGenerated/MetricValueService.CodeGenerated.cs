...
namespace Rock.Model
{
    ...
    public partial class MetricValueViewModelHelper : ViewModelHelper<MetricValue, Rock.ViewModel.Entities.MetricValueBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.MetricValueBag CreateViewModel( MetricValue model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.MetricValueBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class MetricValueExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.MetricValueBag ToViewModel( this MetricValue model, Person currentPerson = null, bool loadAttributes = false )
        {
