...
namespace Rock.Model
{
    ...
    public partial class ConnectionStatusAutomationViewModelHelper : ViewModelHelper<ConnectionStatusAutomation, Rock.ViewModel.Entities.ConnectionStatusAutomationBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ConnectionStatusAutomationBag CreateViewModel( ConnectionStatusAutomation model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ConnectionStatusAutomationBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ConnectionStatusAutomationExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ConnectionStatusAutomationBag ToViewModel( this ConnectionStatusAutomation model, Person currentPerson = null, bool loadAttributes = false )
        {
