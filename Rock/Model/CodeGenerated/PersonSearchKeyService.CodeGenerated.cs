...
namespace Rock.Model
{
    ...
    public partial class PersonSearchKeyViewModelHelper : ViewModelHelper<PersonSearchKey, Rock.ViewModel.Entities.PersonSearchKeyBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.PersonSearchKeyBag CreateViewModel( PersonSearchKey model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.PersonSearchKeyBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class PersonSearchKeyExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.PersonSearchKeyBag ToViewModel( this PersonSearchKey model, Person currentPerson = null, bool loadAttributes = false )
        {
