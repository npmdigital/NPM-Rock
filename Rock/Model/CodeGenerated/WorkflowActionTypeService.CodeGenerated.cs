...
namespace Rock.Model
{
    ...
    public partial class WorkflowActionTypeViewModelHelper : ViewModelHelper<WorkflowActionType, Rock.ViewModel.Entities.WorkflowActionTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.WorkflowActionTypeBag CreateViewModel( WorkflowActionType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.WorkflowActionTypeBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class WorkflowActionTypeExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.WorkflowActionTypeBag ToViewModel( this WorkflowActionType model, Person currentPerson = null, bool loadAttributes = false )
        {
