...
namespace Rock.Model
{
    ...
    public partial class SignatureDocumentTemplateViewModelHelper : ViewModelHelper<SignatureDocumentTemplate, Rock.ViewModel.Entities.SignatureDocumentTemplateBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.SignatureDocumentTemplateBag CreateViewModel( SignatureDocumentTemplate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.SignatureDocumentTemplateBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class SignatureDocumentTemplateExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.SignatureDocumentTemplateBag ToViewModel( this SignatureDocumentTemplate model, Person currentPerson = null, bool loadAttributes = false )
        {
