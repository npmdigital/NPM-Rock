...
namespace Rock.Model
{
    ...
    public partial class SignalTypeViewModelHelper : ViewModelHelper<SignalType, Rock.ViewModel.Entities.SignalTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.SignalTypeBag CreateViewModel( SignalType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.SignalTypeBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class SignalTypeExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.SignalTypeBag ToViewModel( this SignalType model, Person currentPerson = null, bool loadAttributes = false )
        {
