...
namespace Rock.Model
{
    ...
    public partial class ConnectionOpportunityGroupConfigViewModelHelper : ViewModelHelper<ConnectionOpportunityGroupConfig, Rock.ViewModel.Entities.ConnectionOpportunityGroupConfigBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ConnectionOpportunityGroupConfigBag CreateViewModel( ConnectionOpportunityGroupConfig model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ConnectionOpportunityGroupConfigBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ConnectionOpportunityGroupConfigExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ConnectionOpportunityGroupConfigBag ToViewModel( this ConnectionOpportunityGroupConfig model, Person currentPerson = null, bool loadAttributes = false )
        {
