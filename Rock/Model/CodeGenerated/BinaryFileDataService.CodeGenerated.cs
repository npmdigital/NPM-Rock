...
namespace Rock.Model
{
    ...
    public partial class BinaryFileDataViewModelHelper : ViewModelHelper<BinaryFileData, Rock.ViewModel.Entities.BinaryFileDataBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.BinaryFileDataBag CreateViewModel( BinaryFileData model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.BinaryFileDataBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class BinaryFileDataExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.BinaryFileDataBag ToViewModel( this BinaryFileData model, Person currentPerson = null, bool loadAttributes = false )
        {
