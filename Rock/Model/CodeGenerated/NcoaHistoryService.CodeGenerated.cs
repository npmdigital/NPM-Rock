...
namespace Rock.Model
{
    ...
    public partial class NcoaHistoryViewModelHelper : ViewModelHelper<NcoaHistory, Rock.ViewModel.Entities.NcoaHistoryBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.NcoaHistoryBag CreateViewModel( NcoaHistory model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.NcoaHistoryBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class NcoaHistoryExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.NcoaHistoryBag ToViewModel( this NcoaHistory model, Person currentPerson = null, bool loadAttributes = false )
        {
