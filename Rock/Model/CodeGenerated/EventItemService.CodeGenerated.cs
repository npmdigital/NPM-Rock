...
namespace Rock.Model
{
    ...
    public partial class EventItemViewModelHelper : ViewModelHelper<EventItem, Rock.ViewModel.Entities.EventItemBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.EventItemBag CreateViewModel( EventItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.EventItemBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class EventItemExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.EventItemBag ToViewModel( this EventItem model, Person currentPerson = null, bool loadAttributes = false )
        {
