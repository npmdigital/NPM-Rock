...
namespace Rock.Model
{
    ...
    public partial class FinancialPaymentDetailViewModelHelper : ViewModelHelper<FinancialPaymentDetail, Rock.ViewModel.Entities.FinancialPaymentDetailBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.FinancialPaymentDetailBag CreateViewModel( FinancialPaymentDetail model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.FinancialPaymentDetailBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class FinancialPaymentDetailExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.FinancialPaymentDetailBag ToViewModel( this FinancialPaymentDetail model, Person currentPerson = null, bool loadAttributes = false )
        {
