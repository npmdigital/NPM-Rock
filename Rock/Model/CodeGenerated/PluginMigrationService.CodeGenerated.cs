...
namespace Rock.Model
{
    ...
    public partial class PluginMigrationViewModelHelper : ViewModelHelper<PluginMigration, Rock.ViewModel.Entities.PluginMigrationBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.PluginMigrationBag CreateViewModel( PluginMigration model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.PluginMigrationBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class PluginMigrationExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.PluginMigrationBag ToViewModel( this PluginMigration model, Person currentPerson = null, bool loadAttributes = false )
        {
