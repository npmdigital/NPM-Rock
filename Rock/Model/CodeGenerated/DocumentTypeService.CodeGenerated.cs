...
namespace Rock.Model
{
    ...
    public partial class DocumentTypeViewModelHelper : ViewModelHelper<DocumentType, Rock.ViewModel.Entities.DocumentTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.DocumentTypeBag CreateViewModel( DocumentType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.DocumentTypeBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class DocumentTypeExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.DocumentTypeBag ToViewModel( this DocumentType model, Person currentPerson = null, bool loadAttributes = false )
        {
