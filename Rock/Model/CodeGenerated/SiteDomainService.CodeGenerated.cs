...
namespace Rock.Model
{
    ...
    public partial class SiteDomainViewModelHelper : ViewModelHelper<SiteDomain, Rock.ViewModel.Entities.SiteDomainBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.SiteDomainBag CreateViewModel( SiteDomain model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.SiteDomainBag
            {
                Id = model.Id,
                Guid = model.Guid,
                Domain = model.Domain,
    ...
    public static partial class SiteDomainExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.SiteDomainBag ToViewModel( this SiteDomain model, Person currentPerson = null, bool loadAttributes = false )
        {
