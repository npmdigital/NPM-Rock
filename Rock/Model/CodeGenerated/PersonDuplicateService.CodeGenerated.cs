...
namespace Rock.Model
{
    ...
    public partial class PersonDuplicateViewModelHelper : ViewModelHelper<PersonDuplicate, Rock.ViewModel.Entities.PersonDuplicateBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.PersonDuplicateBag CreateViewModel( PersonDuplicate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.PersonDuplicateBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class PersonDuplicateExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.PersonDuplicateBag ToViewModel( this PersonDuplicate model, Person currentPerson = null, bool loadAttributes = false )
        {
