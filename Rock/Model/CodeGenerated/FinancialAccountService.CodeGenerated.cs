...
namespace Rock.Model
{
    ...
    public partial class FinancialAccountViewModelHelper : ViewModelHelper<FinancialAccount, Rock.ViewModel.Entities.FinancialAccountBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.FinancialAccountBag CreateViewModel( FinancialAccount model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.FinancialAccountBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class FinancialAccountExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.FinancialAccountBag ToViewModel( this FinancialAccount model, Person currentPerson = null, bool loadAttributes = false )
        {
