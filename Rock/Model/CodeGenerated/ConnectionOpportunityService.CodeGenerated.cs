...
namespace Rock.Model
{
    ...
    public partial class ConnectionOpportunityViewModelHelper : ViewModelHelper<ConnectionOpportunity, Rock.ViewModel.Entities.ConnectionOpportunityBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ConnectionOpportunityBag CreateViewModel( ConnectionOpportunity model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ConnectionOpportunityBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ConnectionOpportunityExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ConnectionOpportunityBag ToViewModel( this ConnectionOpportunity model, Person currentPerson = null, bool loadAttributes = false )
        {
