...
namespace Rock.Model
{
    ...
    public partial class EntitySetViewModelHelper : ViewModelHelper<EntitySet, Rock.ViewModel.Entities.EntitySetBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.EntitySetBag CreateViewModel( EntitySet model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.EntitySetBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class EntitySetExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.EntitySetBag ToViewModel( this EntitySet model, Person currentPerson = null, bool loadAttributes = false )
        {
