...
namespace Rock.Model
{
    ...
    public partial class AttendanceViewModelHelper : ViewModelHelper<Attendance, Rock.ViewModel.Entities.AttendanceBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.AttendanceBag CreateViewModel( Attendance model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.AttendanceBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class AttendanceExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.AttendanceBag ToViewModel( this Attendance model, Person currentPerson = null, bool loadAttributes = false )
        {
