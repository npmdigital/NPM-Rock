...
namespace Rock.Model
{
    ...
    public partial class DocumentViewModelHelper : ViewModelHelper<Document, Rock.ViewModel.Entities.DocumentBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.DocumentBag CreateViewModel( Document model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.DocumentBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class DocumentExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.DocumentBag ToViewModel( this Document model, Person currentPerson = null, bool loadAttributes = false )
        {
