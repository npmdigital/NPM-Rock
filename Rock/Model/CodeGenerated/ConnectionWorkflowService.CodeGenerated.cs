...
namespace Rock.Model
{
    ...
    public partial class ConnectionWorkflowViewModelHelper : ViewModelHelper<ConnectionWorkflow, Rock.ViewModel.Entities.ConnectionWorkflowBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ConnectionWorkflowBag CreateViewModel( ConnectionWorkflow model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ConnectionWorkflowBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ConnectionWorkflowExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ConnectionWorkflowBag ToViewModel( this ConnectionWorkflow model, Person currentPerson = null, bool loadAttributes = false )
        {
