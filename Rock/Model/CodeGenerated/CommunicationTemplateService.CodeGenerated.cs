...
namespace Rock.Model
{
    ...
    public partial class CommunicationTemplateViewModelHelper : ViewModelHelper<CommunicationTemplate, Rock.ViewModel.Entities.CommunicationTemplateBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.CommunicationTemplateBag CreateViewModel( CommunicationTemplate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.CommunicationTemplateBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class CommunicationTemplateExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.CommunicationTemplateBag ToViewModel( this CommunicationTemplate model, Person currentPerson = null, bool loadAttributes = false )
        {
