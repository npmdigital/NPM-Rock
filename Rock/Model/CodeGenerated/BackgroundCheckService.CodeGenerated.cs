...
namespace Rock.Model
{
    ...
    public partial class BackgroundCheckViewModelHelper : ViewModelHelper<BackgroundCheck, Rock.ViewModel.Entities.BackgroundCheckBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.BackgroundCheckBag CreateViewModel( BackgroundCheck model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.BackgroundCheckBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class BackgroundCheckExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.BackgroundCheckBag ToViewModel( this BackgroundCheck model, Person currentPerson = null, bool loadAttributes = false )
        {
