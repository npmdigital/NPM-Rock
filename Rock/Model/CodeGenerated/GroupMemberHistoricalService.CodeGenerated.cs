...
namespace Rock.Model
{
    ...
    public partial class GroupMemberHistoricalViewModelHelper : ViewModelHelper<GroupMemberHistorical, Rock.ViewModel.Entities.GroupMemberHistoricalBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.GroupMemberHistoricalBag CreateViewModel( GroupMemberHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.GroupMemberHistoricalBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class GroupMemberHistoricalExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.GroupMemberHistoricalBag ToViewModel( this GroupMemberHistorical model, Person currentPerson = null, bool loadAttributes = false )
        {
