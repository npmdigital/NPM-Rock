...
namespace Rock.Model
{
    ...
    public partial class EntitySetItemViewModelHelper : ViewModelHelper<EntitySetItem, Rock.ViewModel.Entities.EntitySetItemBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.EntitySetItemBag CreateViewModel( EntitySetItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.EntitySetItemBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class EntitySetItemExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.EntitySetItemBag ToViewModel( this EntitySetItem model, Person currentPerson = null, bool loadAttributes = false )
        {
