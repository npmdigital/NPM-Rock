...
namespace Rock.Model
{
    ...
    public partial class MergeTemplateViewModelHelper : ViewModelHelper<MergeTemplate, Rock.ViewModel.Entities.MergeTemplateBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.MergeTemplateBag CreateViewModel( MergeTemplate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.MergeTemplateBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class MergeTemplateExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.MergeTemplateBag ToViewModel( this MergeTemplate model, Person currentPerson = null, bool loadAttributes = false )
        {
