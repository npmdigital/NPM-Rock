...
namespace Rock.Model
{
    ...
    public partial class ReportViewModelHelper : ViewModelHelper<Report, Rock.ViewModel.Entities.ReportBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ReportBag CreateViewModel( Report model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ReportBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ReportExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ReportBag ToViewModel( this Report model, Person currentPerson = null, bool loadAttributes = false )
        {
