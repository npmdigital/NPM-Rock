...
namespace Rock.Model
{
    ...
    public partial class NoteAttachmentViewModelHelper : ViewModelHelper<NoteAttachment, Rock.ViewModel.Entities.NoteAttachmentBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.NoteAttachmentBag CreateViewModel( NoteAttachment model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.NoteAttachmentBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class NoteAttachmentExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.NoteAttachmentBag ToViewModel( this NoteAttachment model, Person currentPerson = null, bool loadAttributes = false )
        {
