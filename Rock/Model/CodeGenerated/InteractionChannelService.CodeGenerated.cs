...
namespace Rock.Model
{
    ...
    public partial class InteractionChannelViewModelHelper : ViewModelHelper<InteractionChannel, Rock.ViewModel.Entities.InteractionChannelBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.InteractionChannelBag CreateViewModel( InteractionChannel model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.InteractionChannelBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class InteractionChannelExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.InteractionChannelBag ToViewModel( this InteractionChannel model, Person currentPerson = null, bool loadAttributes = false )
        {
