...
namespace Rock.Model
{
    ...
    public partial class PageContextViewModelHelper : ViewModelHelper<PageContext, Rock.ViewModel.Entities.PageContextBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.PageContextBag CreateViewModel( PageContext model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.PageContextBag
            {
                Id = model.Id,
                Guid = model.Guid,
                Entity = model.Entity,
    ...
    public static partial class PageContextExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.PageContextBag ToViewModel( this PageContext model, Person currentPerson = null, bool loadAttributes = false )
        {
