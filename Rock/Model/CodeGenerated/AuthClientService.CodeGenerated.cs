...
namespace Rock.Model
{
    ...
    public partial class AuthClientViewModelHelper : ViewModelHelper<AuthClient, Rock.ViewModel.Entities.AuthClientBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.AuthClientBag CreateViewModel( AuthClient model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.AuthClientBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class AuthClientExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.AuthClientBag ToViewModel( this AuthClient model, Person currentPerson = null, bool loadAttributes = false )
        {
