...
namespace Rock.Model
{
    ...
    public partial class CampusTopicViewModelHelper : ViewModelHelper<CampusTopic, Rock.ViewModel.Entities.CampusTopicBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.CampusTopicBag CreateViewModel( CampusTopic model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.CampusTopicBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class CampusTopicExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.CampusTopicBag ToViewModel( this CampusTopic model, Person currentPerson = null, bool loadAttributes = false )
        {
