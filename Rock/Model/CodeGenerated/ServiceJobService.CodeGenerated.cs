...
namespace Rock.Model
{
    ...
    public partial class ServiceJobViewModelHelper : ViewModelHelper<ServiceJob, Rock.ViewModel.Entities.ServiceJobBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ServiceJobBag CreateViewModel( ServiceJob model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ServiceJobBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ServiceJobExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ServiceJobBag ToViewModel( this ServiceJob model, Person currentPerson = null, bool loadAttributes = false )
        {
