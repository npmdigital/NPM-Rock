...
namespace Rock.Model
{
    ...
    public partial class FinancialPersonSavedAccountViewModelHelper : ViewModelHelper<FinancialPersonSavedAccount, Rock.ViewModel.Entities.FinancialPersonSavedAccountBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.FinancialPersonSavedAccountBag CreateViewModel( FinancialPersonSavedAccount model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.FinancialPersonSavedAccountBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class FinancialPersonSavedAccountExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.FinancialPersonSavedAccountBag ToViewModel( this FinancialPersonSavedAccount model, Person currentPerson = null, bool loadAttributes = false )
        {
