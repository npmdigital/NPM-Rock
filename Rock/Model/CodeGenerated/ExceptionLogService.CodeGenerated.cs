...
namespace Rock.Model
{
    ...
    public partial class ExceptionLogViewModelHelper : ViewModelHelper<ExceptionLog, Rock.ViewModel.Entities.ExceptionLogBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ExceptionLogBag CreateViewModel( ExceptionLog model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ExceptionLogBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ExceptionLogExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ExceptionLogBag ToViewModel( this ExceptionLog model, Person currentPerson = null, bool loadAttributes = false )
        {
