...
namespace Rock.Model
{
    ...
    public partial class NoteViewModelHelper : ViewModelHelper<Note, Rock.ViewModel.Entities.NoteBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.NoteBag CreateViewModel( Note model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.NoteBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class NoteExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.NoteBag ToViewModel( this Note model, Person currentPerson = null, bool loadAttributes = false )
        {
