...
namespace Rock.Model
{
    ...
    public partial class ReportFieldViewModelHelper : ViewModelHelper<ReportField, Rock.ViewModel.Entities.ReportFieldBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.ReportFieldBag CreateViewModel( ReportField model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.ReportFieldBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class ReportFieldExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.ReportFieldBag ToViewModel( this ReportField model, Person currentPerson = null, bool loadAttributes = false )
        {
