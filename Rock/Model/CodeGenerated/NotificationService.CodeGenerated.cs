...
namespace Rock.Model
{
    ...
    public partial class NotificationViewModelHelper : ViewModelHelper<Notification, Rock.ViewModel.Entities.NotificationBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.Entities.NotificationBag CreateViewModel( Notification model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.Entities.NotificationBag
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class NotificationExtensionMethods
    {
        ...
        public static Rock.ViewModel.Entities.NotificationBag ToViewModel( this Notification model, Person currentPerson = null, bool loadAttributes = false )
        {
